    ...
    return __awaiter(this, void 0, void 0, function* () {
        yield new Promise((res, rej) => {
            fs.createReadStream('Opcodes.csv')
                ...
                .on('end', () => {
                results.forEach(r => {
                    if (r.Instruction.indexOf('LD ') == 0) {
                        generateLD(r);
                    }
                    else if (r.Instruction.indexOf('JP ') == 0) {
                        generateJPJR(r);
                    }
                    else if (r.Instruction.indexOf('JR ') == 0) {
                        generateJPJR(r);
                    }
                    else if (r.Instruction.indexOf('CALL ') == 0) {
                        generateJPJR(r);
                    }
                    else if (r.Instruction.indexOf('INC ') == 0) {
                        generateIncDec(r, true);
                    }
                    else if (r.Instruction.indexOf('DEC ') == 0) {
                        generateIncDec(r, false);
                    }
                    else if (r.Instruction.indexOf('AND ') == 0) {
                        generateAndOrXor(r, 'AND');
                    }
                    else if (r.Instruction.indexOf('OR ') == 0) {
                        generateAndOrXor(r, 'OR');
                    }
                    else if (r.Instruction.indexOf('XOR ') == 0) {
                        generateAndOrXor(r, 'XOR');
                    }
                    else if (r.Instruction.indexOf('OUT ') == 0) {
                        generateLD(r);
                    }
                    else if (r.Instruction.indexOf('IN ') == 0) {
                        generateLD(r);
                    }
                    else if (r.Instruction.indexOf('ADC ') == 0) {
                        generateAddSub(r);
                    }
                    else if (r.Instruction.indexOf('ADD ') == 0) {
                        generateAddSub(r);
                    }
                    else if (r.Instruction.indexOf('SBC ') == 0) {
                        generateAddSub(r);
                    }
                    else if (r.Instruction.indexOf('SUB ') == 0) {
                        generateAddSub(r);
                    }
                    else if (r.Instruction.indexOf('CP ') == 0) {
                        generateAddSub(r);
                    }
                    else if (r.Instruction.indexOf('RL ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('RLC ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('RR ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('RRC ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('RLA ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('RRA ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('SLA ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('SRA ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('SRL ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('SLL ') == 0) {
                        generateShiftRotate(r);
                    }
                    else if (r.Instruction.indexOf('RET') == 0) {
                        generateRet(r);
                    }
                    else if (r.Instruction.indexOf('PUSH ') == 0) {
                        generatePushPop(r);
                    }
                    else if (r.Instruction.indexOf('POP ') == 0) {
                        generatePushPop(r);
                    }
                    else if (r.Instruction.indexOf('BIT ') == 0) {
                        generateBitAndSet(r);
                    }
                    else if (r.Instruction.indexOf('SET ') == 0) {
                        generateBitAndSet(r);
                    }
                    else if (r.Instruction.indexOf('RES ') == 0) {
                        generateBitAndSet(r);
                    }
                    else if (r.Instruction.indexOf('EX') == 0) {
                        generateEx(r);
                    }
                    else if (r.Instruction.indexOf('RST') == 0) {
                        generateRst(r);
                    }
                    else if (r.Instruction.indexOf('IN') == 0) {
                        generateLdCpInOut(r);
                    }
                    else if (r.Instruction.indexOf('O') == 0) {
                        generateLdCpInOut(r);
                    } // OUTI OUTD OTIR and OTID still remaining
                    else if (r.Instruction.indexOf('DJNZ') == 0) {
                        generateDJNZ(r);
                    }
                    else if (r.Instruction.indexOf('LD') == 0) {
                        generateLdCpInOut(r);
                    } // LDI, LDD, LDIR and LDDR
                    else if (r.Instruction.indexOf('CPL') == 0) {
                        generateGeneral(r);
                    }
                    else if (r.Instruction.indexOf('CP') == 0) {
                        generateLdCpInOut(r);
                    } // CPI, CPD, CPIR and CPDR                    
                    else {
