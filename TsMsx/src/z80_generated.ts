...
export class Z80 implements CPU {
    ...
    addOpcodes() {
this.addInstruction(0x8E, (addr: number) => {
// ADC A,(HL) Opcode: 8E
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionDD(0x8E, (addr: number) => {
...
this.addInstructionFD(0x8E, (addr: number) => {
...
this.addInstruction(0xCE, (addr: number) => {
// ADC A,n Opcode: CE n
...
this.addInstruction(0x88, (addr: number) => {
// ADC A,r Opcode: 88+r
let val = this.r8[B];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 4;
...
this.addInstruction(0x89, (addr: number) => {
// ADC A,r Opcode: 88+r
let val = this.r8[C];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 4;
...
this.addInstruction(0x8a, (addr: number) => {
// ADC A,r Opcode: 88+r
let val = this.r8[D];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 4;
...
this.addInstruction(0x8b, (addr: number) => {
// ADC A,r Opcode: 88+r
let val = this.r8[E];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 4;
...
this.addInstruction(0x8c, (addr: number) => {
// ADC A,r Opcode: 88+r
let val = this.r8[H];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 4;
...
this.addInstruction(0x8d, (addr: number) => {
// ADC A,r Opcode: 88+r
let val = this.r8[L];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 4;
...
this.addInstruction(0x8f, (addr: number) => {
// ADC A,r Opcode: 88+r
let val = this.r8[A];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 4;
...
this.addInstructionDD(0x8c, (addr: number) => {
...
this.addInstructionDD(0x8d, (addr: number) => {
// ADC A,IXp Opcode: DD 88+p
let val = this.r8[IXl];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 8;
...
this.addInstructionFD(0x8c, (addr: number) => {
...
this.addInstructionFD(0x8d, (addr: number) => {
// ADC A,IYq Opcode: FD 88+q
let val = this.r8[IYl];
this.r8[A] = this.addSub8(this.r8[A], val, false, true)
this.cycles += 8;
...
this.addInstructionED(0x4A, (addr: number) => {
...
this.addInstructionED(0x5A, (addr: number) => {
...
this.addInstructionED(0x6A, (addr: number) => {
...
this.addInstructionED(0x7A, (addr: number) => {
...
this.addInstruction(0x86, (addr: number) => {
// ADD A,(HL) Opcode: 86
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionDD(0x86, (addr: number) => {
...
this.addInstructionFD(0x86, (addr: number) => {
...
this.addInstruction(0xC6, (addr: number) => {
// ADD A,n Opcode: C6 n
let val = this.memory.uread8(this.r16[PC]++);
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 7;
...
this.addInstruction(0x80, (addr: number) => {
// ADD A,r Opcode: 80+r
let val = this.r8[B];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 4;
...
this.addInstruction(0x81, (addr: number) => {
// ADD A,r Opcode: 80+r
let val = this.r8[C];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 4;
...
this.addInstruction(0x82, (addr: number) => {
// ADD A,r Opcode: 80+r
let val = this.r8[D];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 4;
...
this.addInstruction(0x83, (addr: number) => {
// ADD A,r Opcode: 80+r
let val = this.r8[E];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 4;
...
this.addInstruction(0x84, (addr: number) => {
// ADD A,r Opcode: 80+r
let val = this.r8[H];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 4;
...
this.addInstruction(0x85, (addr: number) => {
// ADD A,r Opcode: 80+r
let val = this.r8[L];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 4;
...
this.addInstruction(0x87, (addr: number) => {
// ADD A,r Opcode: 80+r
let val = this.r8[A];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 4;
...
this.addInstructionDD(0x84, (addr: number) => {
...
this.addInstructionDD(0x85, (addr: number) => {
// ADD A,IXp Opcode: DD 80+p
let val = this.r8[IXl];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 8;
...
this.addInstructionFD(0x84, (addr: number) => {
...
this.addInstructionFD(0x85, (addr: number) => {
// ADD A,IYq Opcode: FD 80+q
let val = this.r8[IYl];
this.r8[A] = this.addSub8(this.r8[A], val, false, false)
this.cycles += 8;
...
this.addInstruction(0x9, (addr: number) => {
// ADD HL,BC Opcode: 9
let val = this.r16[BC];
...
this.addInstruction(0x19, (addr: number) => {
// ADD HL,DE Opcode: 19
let val = this.r16[DE];
this.r16[HL] = this.addSub16(this.r16[HL], val, false, false)
this.cycles += 11;
...
this.addInstruction(0x29, (addr: number) => {
// ADD HL,HL Opcode: 29
let val = this.r16[HL];
this.r16[HL] = this.addSub16(this.r16[HL], val, false, false)
this.cycles += 11;
...
this.addInstruction(0x39, (addr: number) => {
// ADD HL,SP Opcode: 39
let val = this.r16[SP];
this.r16[HL] = this.addSub16(this.r16[HL], val, false, false)
this.cycles += 11;
...
this.addInstructionDD(0x09, (addr: number) => {
...
this.addInstructionDD(0x19, (addr: number) => {
...
this.addInstructionDD(0x29, (addr: number) => {
...
this.addInstructionDD(0x39, (addr: number) => {
...
this.addInstructionFD(0x09, (addr: number) => {
...
this.addInstructionFD(0x19, (addr: number) => {
...
this.addInstructionFD(0x29, (addr: number) => {
...
this.addInstructionFD(0x39, (addr: number) => {
...
this.addInstruction(0xA6, (addr: number) => {
// AND (HL) Opcode: A6
let val = this.memory.uread8(this.r16[HL]);
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstructionDD(0xA6, (addr: number) => {
...
this.addInstructionFD(0xA6, (addr: number) => {
...
this.addInstruction(0xE6, (addr: number) => {
// AND n Opcode: E6 n
let val = this.memory.uread8(this.r16[PC]++);
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstruction(0xa0, (addr: number) => {
// AND r Opcode: A0+r
let val = this.r8[B];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstruction(0xa1, (addr: number) => {
// AND r Opcode: A0+r
let val = this.r8[C];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstruction(0xa2, (addr: number) => {
// AND r Opcode: A0+r
let val = this.r8[D];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstruction(0xa3, (addr: number) => {
// AND r Opcode: A0+r
let val = this.r8[E];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstruction(0xa4, (addr: number) => {
// AND r Opcode: A0+r
let val = this.r8[H];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstruction(0xa5, (addr: number) => {
// AND r Opcode: A0+r
let val = this.r8[L];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstruction(0xa7, (addr: number) => {
// AND r Opcode: A0+r
let val = this.r8[A];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstructionDD(0xa4, (addr: number) => {
// AND IXp Opcode: DD A0+p
let val = this.r8[IXh];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstructionDD(0xa5, (addr: number) => {
// AND IXp Opcode: DD A0+p
let val = this.r8[IXl];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstructionFD(0xa4, (addr: number) => {
// AND IYq Opcode: FD A0+q
let val = this.r8[IYh];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstructionFD(0xa5, (addr: number) => {
// AND IYq Opcode: FD A0+q
let val = this.r8[IYl];
this.logicalOperation(val, LogicalOperation.AND);
});

this.addInstructionCB(0x46, (addr: number) => {
...
this.addInstructionCB(0x4E, (addr: number) => {
// BIT b,(HL) Opcode: CB 46+8*b
let val = this.memory.uread8(this.r16[HL]);
this.bit(1, val)
this.cycles += 12;
...
this.addInstructionCB(0x56, (addr: number) => {
// BIT b,(HL) Opcode: CB 46+8*b
let val = this.memory.uread8(this.r16[HL]);
this.bit(2, val)
this.cycles += 12;
...
this.addInstructionCB(0x5E, (addr: number) => {
// BIT b,(HL) Opcode: CB 46+8*b
let val = this.memory.uread8(this.r16[HL]);
this.bit(3, val)
this.cycles += 12;
...
this.addInstructionCB(0x66, (addr: number) => {
// BIT b,(HL) Opcode: CB 46+8*b
let val = this.memory.uread8(this.r16[HL]);
this.bit(4, val)
this.cycles += 12;
...
this.addInstructionCB(0x6E, (addr: number) => {
// BIT b,(HL) Opcode: CB 46+8*b
let val = this.memory.uread8(this.r16[HL]);
this.bit(5, val)
this.cycles += 12;
...
this.addInstructionCB(0x76, (addr: number) => {
// BIT b,(HL) Opcode: CB 46+8*b
let val = this.memory.uread8(this.r16[HL]);
this.bit(6, val)
this.cycles += 12;
...
this.addInstructionCB(0x7E, (addr: number) => {
// BIT b,(HL) Opcode: CB 46+8*b
let val = this.memory.uread8(this.r16[HL]);
this.bit(7, val)
this.cycles += 12;
...
this.addInstructionDDCB(0x46, (addr: number, o: number) => {
...
this.addInstructionDDCB(0x4E, (addr: number, o: number) => {
// BIT b,(IX+o) Opcode: DD CB o 46+8*b
let val = this.memory.uread8(this.r16[IX] + o);
this.bit(1, val)
this.cycles += 20;
...
this.addInstructionDDCB(0x56, (addr: number, o: number) => {
// BIT b,(IX+o) Opcode: DD CB o 46+8*b
let val = this.memory.uread8(this.r16[IX] + o);
this.bit(2, val)
this.cycles += 20;
...
this.addInstructionDDCB(0x5E, (addr: number, o: number) => {
// BIT b,(IX+o) Opcode: DD CB o 46+8*b
let val = this.memory.uread8(this.r16[IX] + o);
this.bit(3, val)
this.cycles += 20;
...
this.addInstructionDDCB(0x66, (addr: number, o: number) => {
// BIT b,(IX+o) Opcode: DD CB o 46+8*b
let val = this.memory.uread8(this.r16[IX] + o);
this.bit(4, val)
this.cycles += 20;
...
this.addInstructionDDCB(0x6E, (addr: number, o: number) => {
// BIT b,(IX+o) Opcode: DD CB o 46+8*b
let val = this.memory.uread8(this.r16[IX] + o);
this.bit(5, val)
this.cycles += 20;
...
this.addInstructionDDCB(0x76, (addr: number, o: number) => {
// BIT b,(IX+o) Opcode: DD CB o 46+8*b
let val = this.memory.uread8(this.r16[IX] + o);
this.bit(6, val)
this.cycles += 20;
...
this.addInstructionDDCB(0x7E, (addr: number, o: number) => {
// BIT b,(IX+o) Opcode: DD CB o 46+8*b
let val = this.memory.uread8(this.r16[IX] + o);
this.bit(7, val)
this.cycles += 20;
...
this.addInstructionFDCB(0x46, (addr: number, o: number) => {
...
this.addInstructionFDCB(0x4E, (addr: number, o: number) => {
// BIT b,(IY+o) Opcode: FD CB o 46+8*b
let val = this.memory.uread8(this.r16[IY] + o)
this.bit(1, val)
this.cycles += 20;
...
this.addInstructionFDCB(0x56, (addr: number, o: number) => {
// BIT b,(IY+o) Opcode: FD CB o 46+8*b
let val = this.memory.uread8(this.r16[IY] + o)
this.bit(2, val)
this.cycles += 20;
...
this.addInstructionFDCB(0x5E, (addr: number, o: number) => {
// BIT b,(IY+o) Opcode: FD CB o 46+8*b
let val = this.memory.uread8(this.r16[IY] + o)
this.bit(3, val)
this.cycles += 20;
...
this.addInstructionFDCB(0x66, (addr: number, o: number) => {
// BIT b,(IY+o) Opcode: FD CB o 46+8*b
let val = this.memory.uread8(this.r16[IY] + o)
this.bit(4, val)
this.cycles += 20;
...
this.addInstructionFDCB(0x6E, (addr: number, o: number) => {
// BIT b,(IY+o) Opcode: FD CB o 46+8*b
let val = this.memory.uread8(this.r16[IY] + o)
this.bit(5, val)
this.cycles += 20;
...
this.addInstructionFDCB(0x76, (addr: number, o: number) => {
// BIT b,(IY+o) Opcode: FD CB o 46+8*b
let val = this.memory.uread8(this.r16[IY] + o)
this.bit(6, val)
this.cycles += 20;
...
this.addInstructionFDCB(0x7E, (addr: number, o: number) => {
// BIT b,(IY+o) Opcode: FD CB o 46+8*b
let val = this.memory.uread8(this.r16[IY] + o)
this.bit(7, val)
this.cycles += 20;
...
this.addInstructionCB(0x40, (addr: number) => {
...
this.addInstructionCB(0x41, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(0, val)
this.cycles += 8;
...
this.addInstructionCB(0x42, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(0, val)
this.cycles += 8;
...
this.addInstructionCB(0x43, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(0, val)
this.cycles += 8;
...
this.addInstructionCB(0x44, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(0, val)
this.cycles += 8;
...
this.addInstructionCB(0x45, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(0, val)
this.cycles += 8;
...
this.addInstructionCB(0x47, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(0, val)
this.cycles += 8;
...
this.addInstructionCB(0x48, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[B];
this.bit(1, val)
this.cycles += 8;
...
this.addInstructionCB(0x49, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(1, val)
this.cycles += 8;
...
this.addInstructionCB(0x4A, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(1, val)
this.cycles += 8;
...
this.addInstructionCB(0x4B, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(1, val)
this.cycles += 8;
...
this.addInstructionCB(0x4C, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(1, val)
this.cycles += 8;
...
this.addInstructionCB(0x4D, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(1, val)
this.cycles += 8;
...
this.addInstructionCB(0x4F, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(1, val)
this.cycles += 8;
...
this.addInstructionCB(0x50, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[B];
this.bit(2, val)
this.cycles += 8;
...
this.addInstructionCB(0x51, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(2, val)
this.cycles += 8;
...
this.addInstructionCB(0x52, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(2, val)
this.cycles += 8;
...
this.addInstructionCB(0x53, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(2, val)
this.cycles += 8;
...
this.addInstructionCB(0x54, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(2, val)
this.cycles += 8;
...
this.addInstructionCB(0x55, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(2, val)
this.cycles += 8;
...
this.addInstructionCB(0x57, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(2, val)
this.cycles += 8;
...
this.addInstructionCB(0x58, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[B];
this.bit(3, val)
this.cycles += 8;
...
this.addInstructionCB(0x59, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(3, val)
this.cycles += 8;
...
this.addInstructionCB(0x5A, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(3, val)
this.cycles += 8;
...
this.addInstructionCB(0x5B, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(3, val)
this.cycles += 8;
...
this.addInstructionCB(0x5C, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(3, val)
this.cycles += 8;
...
this.addInstructionCB(0x5D, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(3, val)
this.cycles += 8;
...
this.addInstructionCB(0x5F, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(3, val)
this.cycles += 8;
...
this.addInstructionCB(0x60, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[B];
this.bit(4, val)
this.cycles += 8;
...
this.addInstructionCB(0x61, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(4, val)
this.cycles += 8;
...
this.addInstructionCB(0x62, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(4, val)
this.cycles += 8;
...
this.addInstructionCB(0x63, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(4, val)
this.cycles += 8;
...
this.addInstructionCB(0x64, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(4, val)
this.cycles += 8;
...
this.addInstructionCB(0x65, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(4, val)
this.cycles += 8;
...
this.addInstructionCB(0x67, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(4, val)
this.cycles += 8;
...
this.addInstructionCB(0x68, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[B];
this.bit(5, val)
this.cycles += 8;
...
this.addInstructionCB(0x69, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(5, val)
this.cycles += 8;
...
this.addInstructionCB(0x6A, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(5, val)
this.cycles += 8;
...
this.addInstructionCB(0x6B, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(5, val)
this.cycles += 8;
...
this.addInstructionCB(0x6C, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(5, val)
this.cycles += 8;
...
this.addInstructionCB(0x6D, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(5, val)
this.cycles += 8;
...
this.addInstructionCB(0x6F, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(5, val)
this.cycles += 8;
...
this.addInstructionCB(0x70, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[B];
this.bit(6, val)
this.cycles += 8;
...
this.addInstructionCB(0x71, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(6, val)
this.cycles += 8;
...
this.addInstructionCB(0x72, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(6, val)
this.cycles += 8;
...
this.addInstructionCB(0x73, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(6, val)
this.cycles += 8;
...
this.addInstructionCB(0x74, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(6, val)
this.cycles += 8;
...
this.addInstructionCB(0x75, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(6, val)
this.cycles += 8;
...
this.addInstructionCB(0x77, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(6, val)
this.cycles += 8;
...
this.addInstructionCB(0x78, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[B];
this.bit(7, val)
this.cycles += 8;
...
this.addInstructionCB(0x79, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[C];
this.bit(7, val)
this.cycles += 8;
...
this.addInstructionCB(0x7A, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[D];
this.bit(7, val)
this.cycles += 8;
...
this.addInstructionCB(0x7B, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[E];
this.bit(7, val)
this.cycles += 8;
...
this.addInstructionCB(0x7C, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[H];
this.bit(7, val)
this.cycles += 8;
...
this.addInstructionCB(0x7D, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[L];
this.bit(7, val)
this.cycles += 8;
...
this.addInstructionCB(0x7F, (addr: number) => {
// BIT b,r Opcode: CB 40+8*b+r
let val = this.r8[A];
this.bit(7, val)
this.cycles += 8;
...
this.addInstruction(0xCD, (addr: number) => {
...
this.addInstruction(0xDC, (addr: number) => {
...
this.addInstruction(0xFC, (addr: number) => {
...
this.addInstruction(0xD4, (addr: number) => {
...
this.addInstruction(0xC4, (addr: number) => {
...
this.addInstruction(0xF4, (addr: number) => {
...
this.addInstruction(0xEC, (addr: number) => {
...
this.addInstruction(0xE4, (addr: number) => {
...
this.addInstruction(0xCC, (addr: number) => {
...
this.addInstruction(0x3F, (addr: number) => {
// CCF Opcode: 3F
// Carry flag inverted. Also inverts H and clears N. Rest of the flags are preserved.
if (this.r8[F] & Flags.C) { this.r8[F] &= ~Flags.C; } else { this.r8[F] |= Flags.C };
if (this.r8[F] & Flags.H) { this.r8[F] &= ~Flags.H; } else { this.r8[F] |= Flags.H };
this.r8[F] &= ~Flags.N;
this.cycles += 4;
});

this.addInstruction(0xBE, (addr: number) => {
// CP (HL) Opcode: BE
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionDD(0xBE, (addr: number) => {
...
this.addInstructionFD(0xBE, (addr: number) => {
...
this.addInstruction(0xFE, (addr: number) => {
// CP n Opcode: FE n
let val = this.memory.uread8(this.r16[PC]++);
this.addSub8(this.r8[A], val, true, false)
this.cycles += 7;
...
this.addInstruction(0xb8, (addr: number) => {
// CP r Opcode: B8+r
let val = this.r8[B];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0xb9, (addr: number) => {
// CP r Opcode: B8+r
let val = this.r8[C];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0xba, (addr: number) => {
// CP r Opcode: B8+r
let val = this.r8[D];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0xbb, (addr: number) => {
// CP r Opcode: B8+r
let val = this.r8[E];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0xbc, (addr: number) => {
// CP r Opcode: B8+r
let val = this.r8[H];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0xbd, (addr: number) => {
// CP r Opcode: B8+r
let val = this.r8[L];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0xbf, (addr: number) => {
// CP r Opcode: B8+r
let val = this.r8[A];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstructionDD(0xbc, (addr: number) => {
...
this.addInstructionDD(0xbd, (addr: number) => {
// CP IXp Opcode: DD B8+p
let val = this.r8[IXl];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 8;
...
this.addInstructionFD(0xbc, (addr: number) => {
...
this.addInstructionFD(0xbd, (addr: number) => {
// CP IYq Opcode: FD B8+q
let val = this.r8[IYl];
this.addSub8(this.r8[A], val, true, false)
this.cycles += 8;
...
this.addInstructionED(0xA9, (addr: number) => {
// CPD Opcode: ED A9
this.cpi_cpd(false);
this.cycles += 16;
});

this.addInstructionED(0xB9, (addr: number) => {
// CPDR Opcode: ED B9
if(this.r16[BC] > 0) {
while(this.r16[BC] > 0) {
this.cpi_cpd(false);
...
this.addInstructionED(0xA1, (addr: number) => {
// CPI Opcode: ED A1
this.cpi_cpd(true);
this.cycles += 16;
});

this.addInstructionED(0xB1, (addr: number) => {
// CPIR Opcode: ED B1
if(this.r16[BC] > 0) {
while(this.r16[BC] > 0) {
this.cpi_cpd(true);
...
this.addInstruction(0x2F, (addr: number) => {
// CPL Opcode: 2F
this.r8[A] = ~this.r8[A];
this.r8[F] |= (Flags.H | Flags.N);
this.cycles += 4;
...
this.addInstruction(0x27, (addr: number) => {
// DAA Opcode: 27
this.daa();
this.cycles += 4;
});

this.addInstruction(0x35, (addr: number) => {
// DEC (HL) Opcode: 35
let val = this.memory.uread8(this.r16[HL]);
val = this.dec8(val);
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionDD(0x35, (addr: number) => {
...
this.addInstructionFD(0x35, (addr: number) => {
...
this.addInstruction(0x3D, (addr: number) => {
// DEC A Opcode: 3D
this.r8[A] = this.dec8(this.r8[A]);
this.cycles += 4;
});

this.addInstruction(0x5, (addr: number) => {
// DEC B Opcode: 5
this.r8[B] = this.dec8(this.r8[B]);
this.cycles += 4;
});

this.addInstruction(0x0B, (addr: number) => {
// DEC BC Opcode: 0B
let val = this.r16[BC];
val--;
this.r16[BC] = val;
...
this.addInstruction(0x0D, (addr: number) => {
// DEC C Opcode: 0D
this.r8[C] = this.dec8(this.r8[C]);
this.cycles += 4;
});

this.addInstruction(0x15, (addr: number) => {
// DEC D Opcode: 15
this.r8[D] = this.dec8(this.r8[D]);
this.cycles += 4;
});

this.addInstruction(0x1B, (addr: number) => {
// DEC DE Opcode: 1B
let val = this.r16[DE];
val--;
this.r16[DE] = val;
...
this.addInstruction(0x1D, (addr: number) => {
// DEC E Opcode: 1D
this.r8[E] = this.dec8(this.r8[E]);
this.cycles += 4;
});

this.addInstruction(0x25, (addr: number) => {
// DEC H Opcode: 25
this.r8[H] = this.dec8(this.r8[H]);
this.cycles += 4;
});

this.addInstruction(0x2B, (addr: number) => {
// DEC HL Opcode: 2B
let val = this.r16[HL];
val--;
this.r16[HL] = val;
...
this.addInstructionDD(0x2B, (addr: number) => {
// DEC IX Opcode: DD 2B
let val = this.r16[IX];
val--;
this.r16[IX] = val;
...
this.addInstructionFD(0x2B, (addr: number) => {
// DEC IY Opcode: FD 2B
let val = this.r16[IY];
val--;
this.r16[IY] = val;
...
this.addInstruction(0x2D, (addr: number) => {
// DEC L Opcode: 2D
this.r8[L] = this.dec8(this.r8[L]);
this.cycles += 4;
});

this.addInstruction(0x3B, (addr: number) => {
// DEC SP Opcode: 3B
let val = this.r16[SP];
val--;
this.r16[SP] = val;
...
this.addInstruction(0xF3, (addr: number) => {
// DI Opcode: F3
this.disableInterrupts();
this.cycles += 4;
});

this.addInstruction(0x10, (addr: number) => {
// DJNZ o Opcode: 10 o
...
this.addInstruction(0xFB, (addr: number) => {
// EI Opcode: FB
this.enableInterrupts();
this.cycles += 4;
});

this.addInstruction(0xE3, (addr: number) => {
// EX (SP),HL Opcode: E3
let val = this.r16[HL];
...
this.addInstructionDD(0xE3, (addr: number) => {
...
this.addInstructionFD(0xE3, (addr: number) => {
...
this.addInstruction(0x8, (addr: number) => {
// EX AF,AF' Opcode: 8
...
this.addInstruction(0xEB, (addr: number) => {
// EX DE,HL Opcode: EB
let val = this.r16[HL];
...
this.addInstruction(0xD9, (addr: number) => {
// EXX Opcode: D9
let bc = this.r16[BC];
let de = this.r16[DE];
let hl = this.r16[HL];
...
this.addInstruction(0x76, (addr: number) => {
// HALT Opcode: 76
this.halt();
this.cycles += 4;
});

this.addInstructionED(0x46, (addr: number) => {
// IM 0 Opcode: ED 46
this.interruptMode(0);
this.cycles += 8;
});

this.addInstructionED(0x56, (addr: number) => {
// IM 1 Opcode: ED 56
this.interruptMode(1);
this.cycles += 8;
});

this.addInstructionED(0x5E, (addr: number) => {
// IM 2 Opcode: ED 5E
this.interruptMode(2);
this.cycles += 8;
});

this.addInstructionED(0x78, (addr: number) => {
// IN A,(C) Opcode: ED 78
...
this.addInstruction(0xDB, (addr: number) => {
// IN A,(n) Opcode: DB n
...
this.addInstructionED(0x40, (addr: number) => {
// IN B,(C) Opcode: ED 40
let val = this.IO.read8(this.r8[C]);
this.r8[B] = val;
this.cycles += 12;
...
this.addInstructionED(0x48, (addr: number) => {
// IN C,(C) Opcode: ED 48
let val = this.IO.read8(this.r8[C]);
this.r8[C] = val;
this.cycles += 12;
...
this.addInstructionED(0x50, (addr: number) => {
// IN D,(C) Opcode: ED 50
let val = this.IO.read8(this.r8[C]);
this.r8[D] = val;
this.cycles += 12;
...
this.addInstructionED(0x58, (addr: number) => {
// IN E,(C) Opcode: ED 58
let val = this.IO.read8(this.r8[C]);
this.r8[E] = val;
this.cycles += 12;
...
this.addInstructionED(0x60, (addr: number) => {
// IN H,(C) Opcode: ED 60
let val = this.IO.read8(this.r8[C]);
this.r8[H] = val;
this.cycles += 12;
...
this.addInstructionED(0x68, (addr: number) => {
// IN L,(C) Opcode: ED 68
let val = this.IO.read8(this.r8[C]);
this.r8[L] = val;
this.cycles += 12;
...
this.addInstructionED(0x70, (addr: number) => {
// IN F,(C) Opcode: ED 70
let val = this.IO.read8(this.r8[C]);
this.r8[F] = val;
this.cycles += 12;
...
this.addInstructionED(0xAA, (addr: number) => {
// IND Opcode: ED AA
this.ini_inid_outi_outd(true, false);
this.cycles += 16;
});

this.addInstructionED(0xBA, (addr: number) => {
// INDR Opcode: ED BA
if(this.r8[B] > 0) {
while(this.r8[B] > 0) {
this.ini_inid_outi_outd(true, false);
...
this.addInstructionED(0xA2, (addr: number) => {
// INI Opcode: ED A2
this.ini_inid_outi_outd(true, true);
this.cycles += 16;
});

this.addInstructionED(0xB2, (addr: number) => {
// INIR Opcode: ED B2
if(this.r8[B] > 0) {
while(this.r8[B] > 0) {
this.ini_inid_outi_outd(true, true);
...
this.addInstruction(0xC3, (addr: number) => {
...
this.addInstruction(0xE9, (addr: number) => {
// JP (HL) Opcode: E9
this.r16[PC] = this.r16[HL];
this.cycles += 4;
});

this.addInstructionDD(0xE9, (addr: number) => {
// JP (IX) Opcode: DD E9
this.r16[PC] = this.r16[IX];
this.cycles += 8;
});

this.addInstructionFD(0xE9, (addr: number) => {
// JP (IY) Opcode: FD E9
this.r16[PC] = this.r16[IY];
this.cycles += 8;
});

this.addInstruction(0xDA, (addr: number) => {
...
this.addInstruction(0xFA, (addr: number) => {
...
this.addInstruction(0xD2, (addr: number) => {
...
this.addInstruction(0xC2, (addr: number) => {
...
this.addInstruction(0xF2, (addr: number) => {
...
this.addInstruction(0xEA, (addr: number) => {
...
this.addInstruction(0xE2, (addr: number) => {
...
this.addInstruction(0xCA, (addr: number) => {
...
this.addInstruction(0x18, (addr: number) => {
// JR o Opcode: 18 o
...
this.addInstruction(0x38, (addr: number) => {
// JR C,o Opcode: 38 o
let o = this.memory.read8(this.r16[PC]++);
if ((this.r8[F] & Flags.C)) {
this.r16[PC] += o;
...
this.addInstruction(0x30, (addr: number) => {
// JR NC,o Opcode: 30 o
let o = this.memory.read8(this.r16[PC]++);
if (!(this.r8[F] & Flags.C)) {
this.r16[PC] += o;
...
this.addInstruction(0x20, (addr: number) => {
// JR NZ,o Opcode: 20 o
let o = this.memory.read8(this.r16[PC]++);
if (!(this.r8[F] & Flags.Z)) {
this.r16[PC] += o;
...
this.addInstruction(0x28, (addr: number) => {
// JR Z,o Opcode: 28 o
let o = this.memory.read8(this.r16[PC]++);
if ((this.r8[F] & Flags.Z)) {
this.r16[PC] += o;
...
this.addInstructionED(0xA8, (addr: number) => {
// LDD Opcode: ED A8
this.ldi_ldd(false);
this.cycles += 16;
});

this.addInstructionED(0xB8, (addr: number) => {
// LDDR Opcode: ED B8
if(this.r16[BC] > 0) {
while(this.r16[BC] > 0) {
this.ldi_ldd(false);
...
this.addInstructionED(0xA0, (addr: number) => {
// LDI Opcode: ED A0
this.ldi_ldd(true);
this.cycles += 16;
});

this.addInstructionED(0xB0, (addr: number) => {
// LDIR Opcode: ED B0
if(this.r16[BC] > 0) {
while(this.r16[BC] > 0) {
this.ldi_ldd(true);
...
this.addInstructionED(0x44, (addr: number) => {
// NEG Opcode: ED 44
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstruction(0x0, (addr: number) => {
// NOP Opcode: 0
this.cycles += 4;
});

this.addInstruction(0xB6, (addr: number) => {
// OR (HL) Opcode: B6
let val = this.memory.uread8(this.r16[HL]);
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstructionDD(0xB6, (addr: number) => {
...
this.addInstructionFD(0xB6, (addr: number) => {
...
this.addInstruction(0xF6, (addr: number) => {
// OR n Opcode: F6 n
let val = this.memory.uread8(this.r16[PC]++);
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstruction(0xb0, (addr: number) => {
// OR r Opcode: B0+r
let val = this.r8[B];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstruction(0xb1, (addr: number) => {
// OR r Opcode: B0+r
let val = this.r8[C];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstruction(0xb2, (addr: number) => {
// OR r Opcode: B0+r
let val = this.r8[D];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstruction(0xb3, (addr: number) => {
// OR r Opcode: B0+r
let val = this.r8[E];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstruction(0xb4, (addr: number) => {
// OR r Opcode: B0+r
let val = this.r8[H];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstruction(0xb5, (addr: number) => {
// OR r Opcode: B0+r
let val = this.r8[L];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstruction(0xb7, (addr: number) => {
// OR r Opcode: B0+r
let val = this.r8[A];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstructionDD(0xb4, (addr: number) => {
// OR IXp Opcode: DD B0+p
let val = this.r8[IXh];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstructionDD(0xb5, (addr: number) => {
// OR IXp Opcode: DD B0+p
let val = this.r8[IXl];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstructionFD(0xb4, (addr: number) => {
// OR IYq Opcode: FD B0+q
let val = this.r8[IYh];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstructionFD(0xb5, (addr: number) => {
// OR IYq Opcode: FD B0+q
let val = this.r8[IYl];
this.logicalOperation(val, LogicalOperation.OR);
});

this.addInstructionED(0xBB, (addr: number) => {
// OTDR Opcode: ED BB
if(this.r8[B] > 0) {
while(this.r8[B] > 0) {
...
this.addInstructionED(0xB3, (addr: number) => {
// OTIR Opcode: ED B3
if(this.r8[B] > 0) {
while(this.r8[B] > 0) {
...
this.addInstructionED(0xAB, (addr: number) => {
// OUTD Opcode: ED AB
this.ini_inid_outi_outd(false, false);
this.cycles += 16;
});

this.addInstructionED(0xA3, (addr: number) => {
// OUTI Opcode: ED A3
this.ini_inid_outi_outd(false, true);
this.cycles += 16;
});

this.addInstruction(0xF1, (addr: number) => {
// POP AF Opcode: F1
...
this.addInstruction(0xC1, (addr: number) => {
// POP BC Opcode: C1
...
this.addInstruction(0xD1, (addr: number) => {
// POP DE Opcode: D1
...
this.addInstruction(0xE1, (addr: number) => {
// POP HL Opcode: E1
...
this.addInstructionDD(0xE1, (addr: number) => {
// POP IX Opcode: DD E1
...
this.addInstructionFD(0xE1, (addr: number) => {
// POP IY Opcode: FD E1
...
this.addInstruction(0xF5, (addr: number) => {
// PUSH AF Opcode: F5
this.r16[SP] -= 2;
...
this.addInstruction(0xC5, (addr: number) => {
// PUSH BC Opcode: C5
this.r16[SP] -= 2;
...
this.addInstruction(0xD5, (addr: number) => {
// PUSH DE Opcode: D5
this.r16[SP] -= 2;
...
this.addInstruction(0xE5, (addr: number) => {
// PUSH HL Opcode: E5
this.r16[SP] -= 2;
...
this.addInstructionDD(0xE5, (addr: number) => {
...
this.addInstructionFD(0xE5, (addr: number) => {
...
this.addInstructionCB(0x86, (addr: number) => {
...
this.addInstructionCB(0x8E, (addr: number) => {
// RES b,(HL) Opcode: CB 86+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.res(1, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0x96, (addr: number) => {
// RES b,(HL) Opcode: CB 86+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.res(2, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0x9E, (addr: number) => {
// RES b,(HL) Opcode: CB 86+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.res(3, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xA6, (addr: number) => {
// RES b,(HL) Opcode: CB 86+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.res(4, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xAE, (addr: number) => {
// RES b,(HL) Opcode: CB 86+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.res(5, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xB6, (addr: number) => {
// RES b,(HL) Opcode: CB 86+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.res(6, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xBE, (addr: number) => {
// RES b,(HL) Opcode: CB 86+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.res(7, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionDDCB(0x86, (addr: number, o: number) => {
...
this.addInstructionDDCB(0x8E, (addr: number, o: number) => {
// RES b,(IX+o) Opcode: DD CB o 86+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.res(1, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0x96, (addr: number, o: number) => {
// RES b,(IX+o) Opcode: DD CB o 86+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.res(2, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0x9E, (addr: number, o: number) => {
// RES b,(IX+o) Opcode: DD CB o 86+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.res(3, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xA6, (addr: number, o: number) => {
// RES b,(IX+o) Opcode: DD CB o 86+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.res(4, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xAE, (addr: number, o: number) => {
// RES b,(IX+o) Opcode: DD CB o 86+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.res(5, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xB6, (addr: number, o: number) => {
// RES b,(IX+o) Opcode: DD CB o 86+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.res(6, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xBE, (addr: number, o: number) => {
// RES b,(IX+o) Opcode: DD CB o 86+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.res(7, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionFDCB(0x86, (addr: number, o: number) => {
...
this.addInstructionFDCB(0x8E, (addr: number, o: number) => {
// RES b,(IY+o) Opcode: FD CB o 86+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.res(1, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0x96, (addr: number, o: number) => {
// RES b,(IY+o) Opcode: FD CB o 86+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.res(2, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0x9E, (addr: number, o: number) => {
// RES b,(IY+o) Opcode: FD CB o 86+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.res(3, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xA6, (addr: number, o: number) => {
// RES b,(IY+o) Opcode: FD CB o 86+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.res(4, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xAE, (addr: number, o: number) => {
// RES b,(IY+o) Opcode: FD CB o 86+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.res(5, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xB6, (addr: number, o: number) => {
// RES b,(IY+o) Opcode: FD CB o 86+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.res(6, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xBE, (addr: number, o: number) => {
// RES b,(IY+o) Opcode: FD CB o 86+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.res(7, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionCB(0x80, (addr: number) => {
...
this.addInstructionCB(0x81, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(0, val)
this.r8[C] = val;
...
this.addInstructionCB(0x82, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(0, val)
this.r8[D] = val;
...
this.addInstructionCB(0x83, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(0, val)
this.r8[E] = val;
...
this.addInstructionCB(0x84, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(0, val)
this.r8[H] = val;
...
this.addInstructionCB(0x85, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(0, val)
this.r8[L] = val;
...
this.addInstructionCB(0x87, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(0, val)
this.r8[A] = val;
...
this.addInstructionCB(0x88, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[B];
val = this.res(1, val)
this.r8[B] = val;
...
this.addInstructionCB(0x89, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(1, val)
this.r8[C] = val;
...
this.addInstructionCB(0x8A, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(1, val)
this.r8[D] = val;
...
this.addInstructionCB(0x8B, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(1, val)
this.r8[E] = val;
...
this.addInstructionCB(0x8C, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(1, val)
this.r8[H] = val;
...
this.addInstructionCB(0x8D, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(1, val)
this.r8[L] = val;
...
this.addInstructionCB(0x8F, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(1, val)
this.r8[A] = val;
...
this.addInstructionCB(0x90, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[B];
val = this.res(2, val)
this.r8[B] = val;
...
this.addInstructionCB(0x91, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(2, val)
this.r8[C] = val;
...
this.addInstructionCB(0x92, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(2, val)
this.r8[D] = val;
...
this.addInstructionCB(0x93, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(2, val)
this.r8[E] = val;
...
this.addInstructionCB(0x94, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(2, val)
this.r8[H] = val;
...
this.addInstructionCB(0x95, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(2, val)
this.r8[L] = val;
...
this.addInstructionCB(0x97, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(2, val)
this.r8[A] = val;
...
this.addInstructionCB(0x98, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[B];
val = this.res(3, val)
this.r8[B] = val;
...
this.addInstructionCB(0x99, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(3, val)
this.r8[C] = val;
...
this.addInstructionCB(0x9A, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(3, val)
this.r8[D] = val;
...
this.addInstructionCB(0x9B, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(3, val)
this.r8[E] = val;
...
this.addInstructionCB(0x9C, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(3, val)
this.r8[H] = val;
...
this.addInstructionCB(0x9D, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(3, val)
this.r8[L] = val;
...
this.addInstructionCB(0x9F, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(3, val)
this.r8[A] = val;
...
this.addInstructionCB(0xA0, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[B];
val = this.res(4, val)
this.r8[B] = val;
...
this.addInstructionCB(0xA1, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(4, val)
this.r8[C] = val;
...
this.addInstructionCB(0xA2, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(4, val)
this.r8[D] = val;
...
this.addInstructionCB(0xA3, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(4, val)
this.r8[E] = val;
...
this.addInstructionCB(0xA4, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(4, val)
this.r8[H] = val;
...
this.addInstructionCB(0xA5, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(4, val)
this.r8[L] = val;
...
this.addInstructionCB(0xA7, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(4, val)
this.r8[A] = val;
...
this.addInstructionCB(0xA8, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[B];
val = this.res(5, val)
this.r8[B] = val;
...
this.addInstructionCB(0xA9, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(5, val)
this.r8[C] = val;
...
this.addInstructionCB(0xAA, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(5, val)
this.r8[D] = val;
...
this.addInstructionCB(0xAB, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(5, val)
this.r8[E] = val;
...
this.addInstructionCB(0xAC, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(5, val)
this.r8[H] = val;
...
this.addInstructionCB(0xAD, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(5, val)
this.r8[L] = val;
...
this.addInstructionCB(0xAF, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(5, val)
this.r8[A] = val;
...
this.addInstructionCB(0xB0, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[B];
val = this.res(6, val)
this.r8[B] = val;
...
this.addInstructionCB(0xB1, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(6, val)
this.r8[C] = val;
...
this.addInstructionCB(0xB2, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(6, val)
this.r8[D] = val;
...
this.addInstructionCB(0xB3, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(6, val)
this.r8[E] = val;
...
this.addInstructionCB(0xB4, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(6, val)
this.r8[H] = val;
...
this.addInstructionCB(0xB5, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(6, val)
this.r8[L] = val;
...
this.addInstructionCB(0xB7, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(6, val)
this.r8[A] = val;
...
this.addInstructionCB(0xB8, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[B];
val = this.res(7, val)
this.r8[B] = val;
...
this.addInstructionCB(0xB9, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[C];
val = this.res(7, val)
this.r8[C] = val;
...
this.addInstructionCB(0xBA, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[D];
val = this.res(7, val)
this.r8[D] = val;
...
this.addInstructionCB(0xBB, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[E];
val = this.res(7, val)
this.r8[E] = val;
...
this.addInstructionCB(0xBC, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[H];
val = this.res(7, val)
this.r8[H] = val;
...
this.addInstructionCB(0xBD, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[L];
val = this.res(7, val)
this.r8[L] = val;
...
this.addInstructionCB(0xBF, (addr: number) => {
// RES b,r Opcode: CB 80+8*b+r
let val = this.r8[A];
val = this.res(7, val)
this.r8[A] = val;
...
this.addInstruction(0xC9, (addr: number) => {
// RET Opcode: C9
...
this.addInstruction(0xD8, (addr: number) => {
// RET C Opcode: D8
if ((this.r8[F] & Flags.C)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstruction(0xF8, (addr: number) => {
// RET M Opcode: F8
if ((this.r8[F] & Flags.S)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstruction(0xD0, (addr: number) => {
// RET NC Opcode: D0
if (!(this.r8[F] & Flags.C)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstruction(0xC0, (addr: number) => {
// RET NZ Opcode: C0
if (!(this.r8[F] & Flags.Z)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstruction(0xF0, (addr: number) => {
// RET P Opcode: F0
if (!(this.r8[F] & Flags.S)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstruction(0xE8, (addr: number) => {
// RET PE Opcode: E8
if ((this.r8[F] & Flags.PV)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstruction(0xE0, (addr: number) => {
// RET PO Opcode: E0
if (!(this.r8[F] & Flags.PV)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstruction(0xC8, (addr: number) => {
// RET Z Opcode: C8
if ((this.r8[F] & Flags.Z)) {
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
...
this.addInstructionED(0x4D, (addr: number) => {
// RETI Opcode: ED 4D
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
this.cycles += 14;
...
this.addInstructionED(0x45, (addr: number) => {
// RETN Opcode: ED 45
this.r16[PC] = this.memory.uread16(this.r16[SP]);
this.r16[SP] += 2;
this.cycles += 14;
...
this.addInstruction(0x17, (addr: number) => {
// RLA Opcode: 17
...
this.addInstruction(0x7, (addr: number) => {
// RLCA Opcode: 7
let temp_flags = this.r8[F];
...
this.addInstructionED(0x6F, (addr: number) => {
// RLD Opcode: ED 6F
this.rotateRLD();
this.cycles += 18;
});
...
this.addInstruction(0x1F, (addr: number) => {
// RRA Opcode: 1F
let temp_flags = this.r8[F];
this.r8[A] = this.rotateRight(this.r8[A]);
// Flags S, Z and PV are not set
...
this.addInstruction(0x0F, (addr: number) => {
// RRCA Opcode: 0F
let temp_flags = this.r8[F];
this.r8[A] = this.rotateRightCarry(this.r8[A]);
// Flags S, Z and PV are not set
...
this.addInstructionED(0x67, (addr: number) => {
// RRD Opcode: ED 67
this.rotateRRD();
this.cycles += 18;
});

this.addInstruction(0xC7, (addr: number) => {
// RST 0 Opcode: C7
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x0;
...
this.addInstruction(0xCF, (addr: number) => {
// RST 8H Opcode: CF
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x8;
...
this.addInstruction(0xD7, (addr: number) => {
// RST 10H Opcode: D7
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x10;
...
this.addInstruction(0xDF, (addr: number) => {
// RST 18H Opcode: DF
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x18;
...
this.addInstruction(0xE7, (addr: number) => {
// RST 20H Opcode: E7
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x20;
...
this.addInstruction(0xEF, (addr: number) => {
// RST 28H Opcode: EF
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x28;
...
this.addInstruction(0xF7, (addr: number) => {
// RST 30H Opcode: F7
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x30;
...
this.addInstruction(0xFF, (addr: number) => {
// RST 38H Opcode: FF
this.r16[SP] -= 2;
    this.memory.uwrite16(this.r16[SP], this.r16[PC]);
    this.r16[PC] = 0x38;
...
this.addInstruction(0x9E, (addr: number) => {
// SBC A,(HL) Opcode: 9E
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionDD(0x9E, (addr: number) => {
...
this.addInstructionFD(0x9E, (addr: number) => {
...
this.addInstruction(0xDE, (addr: number) => {
// SBC A,n Opcode: DE n
let val = this.memory.uread8(this.r16[PC]++);
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 7;
...
this.addInstruction(0x98, (addr: number) => {
// SBC A,r Opcode: 98+r
let val = this.r8[B];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 4;
...
this.addInstruction(0x99, (addr: number) => {
// SBC A,r Opcode: 98+r
let val = this.r8[C];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 4;
...
this.addInstruction(0x9a, (addr: number) => {
// SBC A,r Opcode: 98+r
let val = this.r8[D];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 4;
...
this.addInstruction(0x9b, (addr: number) => {
// SBC A,r Opcode: 98+r
let val = this.r8[E];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 4;
...
this.addInstruction(0x9c, (addr: number) => {
// SBC A,r Opcode: 98+r
let val = this.r8[H];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 4;
...
this.addInstruction(0x9d, (addr: number) => {
// SBC A,r Opcode: 98+r
let val = this.r8[L];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 4;
...
this.addInstruction(0x9f, (addr: number) => {
// SBC A,r Opcode: 98+r
let val = this.r8[A];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 4;
...
this.addInstructionDD(0x9c, (addr: number) => {
...
this.addInstructionDD(0x9d, (addr: number) => {
// SBC A,IXp Opcode: DD 98+p
let val = this.r8[IXl];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 8;
...
this.addInstructionFD(0x9c, (addr: number) => {
...
this.addInstructionFD(0x9d, (addr: number) => {
// SBC A,IYq Opcode: FD 98+q
let val = this.r8[IYl];
this.r8[A] = this.addSub8(this.r8[A], val, true, true)
this.cycles += 8;
...
this.addInstructionED(0x42, (addr: number) => {
...
this.addInstructionED(0x52, (addr: number) => {
...
this.addInstructionED(0x62, (addr: number) => {
...
this.addInstructionED(0x72, (addr: number) => {
...
this.addInstruction(0x37, (addr: number) => {
// SCF Opcode: 37
...
this.addInstructionCB(0xC6, (addr: number) => {
...
this.addInstructionCB(0xCE, (addr: number) => {
// SET b,(HL) Opcode: CB C6+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.set(1, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xD6, (addr: number) => {
// SET b,(HL) Opcode: CB C6+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.set(2, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xDE, (addr: number) => {
// SET b,(HL) Opcode: CB C6+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.set(3, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xE6, (addr: number) => {
// SET b,(HL) Opcode: CB C6+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.set(4, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xEE, (addr: number) => {
// SET b,(HL) Opcode: CB C6+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.set(5, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xF6, (addr: number) => {
// SET b,(HL) Opcode: CB C6+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.set(6, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionCB(0xFE, (addr: number) => {
// SET b,(HL) Opcode: CB C6+8*b
let val = this.memory.uread8(this.r16[HL]);
val = this.set(7, val)
this.memory.uwrite8(this.r16[HL], val);
...
this.addInstructionDDCB(0xC6, (addr: number, o: number) => {
...
this.addInstructionDDCB(0xCE, (addr: number, o: number) => {
// SET b,(IX+o) Opcode: DD CB o C6+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.set(1, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xD6, (addr: number, o: number) => {
// SET b,(IX+o) Opcode: DD CB o C6+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.set(2, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xDE, (addr: number, o: number) => {
// SET b,(IX+o) Opcode: DD CB o C6+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.set(3, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xE6, (addr: number, o: number) => {
// SET b,(IX+o) Opcode: DD CB o C6+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.set(4, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xEE, (addr: number, o: number) => {
// SET b,(IX+o) Opcode: DD CB o C6+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.set(5, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xF6, (addr: number, o: number) => {
// SET b,(IX+o) Opcode: DD CB o C6+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.set(6, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionDDCB(0xFE, (addr: number, o: number) => {
// SET b,(IX+o) Opcode: DD CB o C6+8*b
let val = this.memory.uread8(this.r16[IX] + o);
val = this.set(7, val)
this.memory.uwrite8(this.r16[IX] + o, val);
...
this.addInstructionFDCB(0xC6, (addr: number, o: number) => {
...
this.addInstructionFDCB(0xCE, (addr: number, o: number) => {
// SET b,(IY+o) Opcode: FD CB o C6+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.set(1, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xD6, (addr: number, o: number) => {
// SET b,(IY+o) Opcode: FD CB o C6+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.set(2, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xDE, (addr: number, o: number) => {
// SET b,(IY+o) Opcode: FD CB o C6+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.set(3, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xE6, (addr: number, o: number) => {
// SET b,(IY+o) Opcode: FD CB o C6+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.set(4, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xEE, (addr: number, o: number) => {
// SET b,(IY+o) Opcode: FD CB o C6+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.set(5, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xF6, (addr: number, o: number) => {
// SET b,(IY+o) Opcode: FD CB o C6+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.set(6, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionFDCB(0xFE, (addr: number, o: number) => {
// SET b,(IY+o) Opcode: FD CB o C6+8*b
let val = this.memory.uread8(this.r16[IY] + o)
val = this.set(7, val)
this.memory.uwrite8(this.r16[IY] + o, val);
...
this.addInstructionCB(0xC0, (addr: number) => {
...
this.addInstructionCB(0xC1, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(0, val)
this.r8[C] = val;
...
this.addInstructionCB(0xC2, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(0, val)
this.r8[D] = val;
...
this.addInstructionCB(0xC3, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(0, val)
this.r8[E] = val;
...
this.addInstructionCB(0xC4, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(0, val)
this.r8[H] = val;
...
this.addInstructionCB(0xC5, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(0, val)
this.r8[L] = val;
...
this.addInstructionCB(0xC7, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(0, val)
this.r8[A] = val;
...
this.addInstructionCB(0xC8, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[B];
val = this.set(1, val)
this.r8[B] = val;
...
this.addInstructionCB(0xC9, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(1, val)
this.r8[C] = val;
...
this.addInstructionCB(0xCA, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(1, val)
this.r8[D] = val;
...
this.addInstructionCB(0xCB, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(1, val)
this.r8[E] = val;
...
this.addInstructionCB(0xCC, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(1, val)
this.r8[H] = val;
...
this.addInstructionCB(0xCD, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(1, val)
this.r8[L] = val;
...
this.addInstructionCB(0xCF, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(1, val)
this.r8[A] = val;
...
this.addInstructionCB(0xD0, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[B];
val = this.set(2, val)
this.r8[B] = val;
...
this.addInstructionCB(0xD1, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(2, val)
this.r8[C] = val;
...
this.addInstructionCB(0xD2, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(2, val)
this.r8[D] = val;
...
this.addInstructionCB(0xD3, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(2, val)
this.r8[E] = val;
...
this.addInstructionCB(0xD4, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(2, val)
this.r8[H] = val;
...
this.addInstructionCB(0xD5, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(2, val)
this.r8[L] = val;
...
this.addInstructionCB(0xD7, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(2, val)
this.r8[A] = val;
...
this.addInstructionCB(0xD8, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[B];
val = this.set(3, val)
this.r8[B] = val;
...
this.addInstructionCB(0xD9, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(3, val)
this.r8[C] = val;
...
this.addInstructionCB(0xDA, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(3, val)
this.r8[D] = val;
...
this.addInstructionCB(0xDB, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(3, val)
this.r8[E] = val;
...
this.addInstructionCB(0xDC, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(3, val)
this.r8[H] = val;
...
this.addInstructionCB(0xDD, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(3, val)
this.r8[L] = val;
...
this.addInstructionCB(0xDF, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(3, val)
this.r8[A] = val;
...
this.addInstructionCB(0xE0, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[B];
val = this.set(4, val)
this.r8[B] = val;
...
this.addInstructionCB(0xE1, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(4, val)
this.r8[C] = val;
...
this.addInstructionCB(0xE2, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(4, val)
this.r8[D] = val;
...
this.addInstructionCB(0xE3, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(4, val)
this.r8[E] = val;
...
this.addInstructionCB(0xE4, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(4, val)
this.r8[H] = val;
...
this.addInstructionCB(0xE5, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(4, val)
this.r8[L] = val;
...
this.addInstructionCB(0xE7, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(4, val)
this.r8[A] = val;
...
this.addInstructionCB(0xE8, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[B];
val = this.set(5, val)
this.r8[B] = val;
...
this.addInstructionCB(0xE9, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(5, val)
this.r8[C] = val;
...
this.addInstructionCB(0xEA, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(5, val)
this.r8[D] = val;
...
this.addInstructionCB(0xEB, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(5, val)
this.r8[E] = val;
...
this.addInstructionCB(0xEC, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(5, val)
this.r8[H] = val;
...
this.addInstructionCB(0xED, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(5, val)
this.r8[L] = val;
...
this.addInstructionCB(0xEF, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(5, val)
this.r8[A] = val;
...
this.addInstructionCB(0xF0, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[B];
val = this.set(6, val)
this.r8[B] = val;
...
this.addInstructionCB(0xF1, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(6, val)
this.r8[C] = val;
...
this.addInstructionCB(0xF2, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(6, val)
this.r8[D] = val;
...
this.addInstructionCB(0xF3, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(6, val)
this.r8[E] = val;
...
this.addInstructionCB(0xF4, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(6, val)
this.r8[H] = val;
...
this.addInstructionCB(0xF5, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(6, val)
this.r8[L] = val;
...
this.addInstructionCB(0xF7, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(6, val)
this.r8[A] = val;
...
this.addInstructionCB(0xF8, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[B];
val = this.set(7, val)
this.r8[B] = val;
...
this.addInstructionCB(0xF9, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[C];
val = this.set(7, val)
this.r8[C] = val;
...
this.addInstructionCB(0xFA, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[D];
val = this.set(7, val)
this.r8[D] = val;
...
this.addInstructionCB(0xFB, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[E];
val = this.set(7, val)
this.r8[E] = val;
...
this.addInstructionCB(0xFC, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[H];
val = this.set(7, val)
this.r8[H] = val;
...
this.addInstructionCB(0xFD, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[L];
val = this.set(7, val)
this.r8[L] = val;
...
this.addInstructionCB(0xFF, (addr: number) => {
// SET b,r Opcode: CB C0+8*b+r
let val = this.r8[A];
val = this.set(7, val)
this.r8[A] = val;
...
this.addInstructionCB(0x26, (addr: number) => {
// SLA (HL) Opcode: CB 26
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionDDCB(0x26, (addr: number, o: number) => {
...
this.addInstructionFDCB(0x26, (addr: number, o: number) => {
...
this.addInstructionCB(0x20, (addr: number) => {
// SLA r Opcode: CB 20+r
this.r8[B] = this.shiftLeft(this.r8[B]);
this.cycles += 8;
});

this.addInstructionCB(0x21, (addr: number) => {
// SLA r Opcode: CB 20+r
this.r8[C] = this.shiftLeft(this.r8[C]);
this.cycles += 8;
});

this.addInstructionCB(0x22, (addr: number) => {
// SLA r Opcode: CB 20+r
this.r8[D] = this.shiftLeft(this.r8[D]);
this.cycles += 8;
});

this.addInstructionCB(0x23, (addr: number) => {
// SLA r Opcode: CB 20+r
this.r8[E] = this.shiftLeft(this.r8[E]);
this.cycles += 8;
});

this.addInstructionCB(0x24, (addr: number) => {
// SLA r Opcode: CB 20+r
this.r8[H] = this.shiftLeft(this.r8[H]);
this.cycles += 8;
});

this.addInstructionCB(0x25, (addr: number) => {
// SLA r Opcode: CB 20+r
this.r8[L] = this.shiftLeft(this.r8[L]);
this.cycles += 8;
});

this.addInstructionCB(0x27, (addr: number) => {
// SLA r Opcode: CB 20+r
this.r8[A] = this.shiftLeft(this.r8[A]);
this.cycles += 8;
});

this.addInstructionCB(0x2E, (addr: number) => {
// SRA (HL) Opcode: CB 2E
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionDDCB(0x2E, (addr: number, o: number) => {
...
this.addInstructionFDCB(0x2E, (addr: number, o: number) => {
...
this.addInstructionDDCB(0x3E, (addr: number, o: number) => {
...
this.addInstructionFDCB(0x3E, (addr: number, o: number) => {
...
this.addInstructionCB(0x38, (addr: number) => {
// SRL r Opcode: CB 38+r
this.r8[B] = this.shiftRightLogic(this.r8[B]);
this.cycles += 8;
});

this.addInstructionCB(0x39, (addr: number) => {
// SRL r Opcode: CB 38+r
this.r8[C] = this.shiftRightLogic(this.r8[C]);
this.cycles += 8;
});

this.addInstructionCB(0x3a, (addr: number) => {
// SRL r Opcode: CB 38+r
this.r8[D] = this.shiftRightLogic(this.r8[D]);
this.cycles += 8;
});

this.addInstructionCB(0x3b, (addr: number) => {
// SRL r Opcode: CB 38+r
this.r8[E] = this.shiftRightLogic(this.r8[E]);
this.cycles += 8;
});

this.addInstructionCB(0x3c, (addr: number) => {
// SRL r Opcode: CB 38+r
this.r8[H] = this.shiftRightLogic(this.r8[H]);
this.cycles += 8;
});

this.addInstructionCB(0x3d, (addr: number) => {
// SRL r Opcode: CB 38+r
this.r8[L] = this.shiftRightLogic(this.r8[L]);
this.cycles += 8;
});

this.addInstructionCB(0x3f, (addr: number) => {
// SRL r Opcode: CB 38+r
this.r8[A] = this.shiftRightLogic(this.r8[A]);
this.cycles += 8;
});

this.addInstruction(0x96, (addr: number) => {
// SUB (HL) Opcode: 96
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionDD(0x96, (addr: number) => {
...
this.addInstructionFD(0x96, (addr: number) => {
...
this.addInstruction(0xD6, (addr: number) => {
// SUB n Opcode: D6 n
let val = this.memory.uread8(this.r16[PC]++);
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 7;
...
this.addInstruction(0x90, (addr: number) => {
// SUB r Opcode: 90+r
let val = this.r8[B];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0x91, (addr: number) => {
// SUB r Opcode: 90+r
let val = this.r8[C];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0x92, (addr: number) => {
// SUB r Opcode: 90+r
let val = this.r8[D];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0x93, (addr: number) => {
// SUB r Opcode: 90+r
let val = this.r8[E];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0x94, (addr: number) => {
// SUB r Opcode: 90+r
let val = this.r8[H];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0x95, (addr: number) => {
// SUB r Opcode: 90+r
let val = this.r8[L];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstruction(0x97, (addr: number) => {
// SUB r Opcode: 90+r
let val = this.r8[A];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 4;
...
this.addInstructionDD(0x94, (addr: number) => {
...
this.addInstructionDD(0x95, (addr: number) => {
// SUB IXp Opcode: DD 90+p
let val = this.r8[IXl];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 8;
...
this.addInstructionFD(0x94, (addr: number) => {
...
this.addInstructionFD(0x95, (addr: number) => {
// SUB IYq Opcode: FD 90+q
let val = this.r8[IYl];
this.r8[A] = this.addSub8(this.r8[A], val, true, false)
this.cycles += 8;
...
this.addInstruction(0xAE, (addr: number) => {
// XOR (HL) Opcode: AE
let val = this.memory.uread8(this.r16[HL]);
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstructionDD(0xAE, (addr: number) => {
...
this.addInstructionFD(0xAE, (addr: number) => {
...
this.addInstruction(0xEE, (addr: number) => {
// XOR n Opcode: EE n
let val = this.memory.uread8(this.r16[PC]++);
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstruction(0xa8, (addr: number) => {
// XOR r Opcode: A8+r
let val = this.r8[B];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstruction(0xa9, (addr: number) => {
// XOR r Opcode: A8+r
let val = this.r8[C];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstruction(0xaa, (addr: number) => {
// XOR r Opcode: A8+r
let val = this.r8[D];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstruction(0xab, (addr: number) => {
// XOR r Opcode: A8+r
let val = this.r8[E];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstruction(0xac, (addr: number) => {
// XOR r Opcode: A8+r
let val = this.r8[H];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstruction(0xad, (addr: number) => {
// XOR r Opcode: A8+r
let val = this.r8[L];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstruction(0xaf, (addr: number) => {
// XOR r Opcode: A8+r
let val = this.r8[A];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstructionDD(0xac, (addr: number) => {
// XOR IXp Opcode: DD A8+p
let val = this.r8[IXh];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstructionDD(0xad, (addr: number) => {
// XOR IXp Opcode: DD A8+p
let val = this.r8[IXl];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstructionFD(0xac, (addr: number) => {
// XOR IYq Opcode: FD A8+q
let val = this.r8[IYh];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstructionFD(0xad, (addr: number) => {
// XOR IYq Opcode: FD A8+q
let val = this.r8[IYl];
this.logicalOperation(val, LogicalOperation.XOR);
});

this.addInstructionED(0x4C, (addr: number) => {
// NEG Opcode: ED 4C
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstructionED(0x54, (addr: number) => {
// NEG Opcode: ED 54
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstructionED(0x5C, (addr: number) => {
// NEG Opcode: ED 5C
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstructionED(0x64, (addr: number) => {
// NEG Opcode: ED 64
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstructionED(0x6C, (addr: number) => {
// NEG Opcode: ED 6C
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstructionED(0x74, (addr: number) => {
// NEG Opcode: ED 74
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstructionED(0x7C, (addr: number) => {
// NEG Opcode: ED 7C
this.r8[A] = this.neg(this.r8[A]);
this.cycles += 8;
});

this.addInstructionDD(0x24, (addr: number) => {
// INC IXh Opcode: DD 24
this.r8[IXh] = this.inc8(this.r8[IXh]);
this.cycles += 8;
});

this.addInstructionDD(0x2C, (addr: number) => {
// INC IXl Opcode: DD 2C
this.r8[IXl] = this.inc8(this.r8[IXl]);
this.cycles += 8;
});

this.addInstructionDD(0x25, (addr: number) => {
// DEC IXh Opcode: DD 25
this.r8[IXh] = this.dec8(this.r8[IXh]);
this.cycles += 8;
});

this.addInstructionDD(0x2D, (addr: number) => {
// DEC IXl Opcode: DD 2D
this.r8[IXl] = this.dec8(this.r8[IXl]);
this.cycles += 8;
});

this.addInstructionFD(0x24, (addr: number) => {
// INC IYh Opcode: FD 24
this.r8[IYh] = this.inc8(this.r8[IYh]);
this.cycles += 8;
});

this.addInstructionFD(0x2C, (addr: number) => {
// INC IYl Opcode: FD 2C
this.r8[IYl] = this.inc8(this.r8[IYl]);
this.cycles += 8;
});

this.addInstructionFD(0x25, (addr: number) => {
// DEC IYh Opcode: FD 25
this.r8[IYh] = this.dec8(this.r8[IYh]);
this.cycles += 8;
});

this.addInstructionFD(0x2D, (addr: number) => {
// DEC IYl Opcode: FD 2D
this.r8[IYl] = this.dec8(this.r8[IYl]);
this.cycles += 8;
});

this.addInstructionCB(0x36, (addr: number) => {
// SLL (HL) Opcode: CB 36
let val = this.memory.uread8(this.r16[HL]);
...
this.addInstructionCB(0x30, (addr: number) => {
// SLL r Opcode: CB 30+r
this.r8[B] = this.shiftLeftLogical(this.r8[B]);
this.cycles += 8;
});

this.addInstructionCB(0x31, (addr: number) => {
// SLL r Opcode: CB 30+r
this.r8[C] = this.shiftLeftLogical(this.r8[C]);
this.cycles += 8;
});

this.addInstructionCB(0x32, (addr: number) => {
// SLL r Opcode: CB 30+r
this.r8[D] = this.shiftLeftLogical(this.r8[D]);
this.cycles += 8;
});

this.addInstructionCB(0x33, (addr: number) => {
// SLL r Opcode: CB 30+r
this.r8[E] = this.shiftLeftLogical(this.r8[E]);
this.cycles += 8;
});

this.addInstructionCB(0x34, (addr: number) => {
// SLL r Opcode: CB 30+r
this.r8[H] = this.shiftLeftLogical(this.r8[H]);
this.cycles += 8;
});

this.addInstructionCB(0x35, (addr: number) => {
// SLL r Opcode: CB 30+r
this.r8[L] = this.shiftLeftLogical(this.r8[L]);
this.cycles += 8;
});

this.addInstructionCB(0x37, (addr: number) => {
// SLL r Opcode: CB 30+r
